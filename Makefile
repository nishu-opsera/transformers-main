...
.PHONY: style typing check-code-quality check-repository-consistency check-import-linter check-layer-violations check-repo fix-repo test test-examples benchmark codex claude clean-ai
